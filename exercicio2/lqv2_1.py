...
class Lqv2_1:
    ...
    def window(self, x, d1, d2, width = 0.10):
    ...
    def train(self, features, labels, train_size, prototype_amount, categories, iterations=200, learning_rate=0.0g1, threshold=0.10):
        ...
        prototype_trained = Lqv1.train(train, train_labels, prototype_set, prototype_label, 25, 1, 0.10)
        ...
        while iterations > 0 and err > threshold and learning_rate > -1:
            ...
            err = 1 - Lqv1.test_prototype(prototype_trained, prototype_label, train, train_labels, k=2)
            print("err " + str(err))

        return prototype_trained, prototype_label
